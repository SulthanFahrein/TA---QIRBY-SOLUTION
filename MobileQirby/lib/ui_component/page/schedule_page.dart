...
import 'package:test_ta_1/core/model/schedule.dart' as ScheduleModel;
...
import 'package:test_ta_1/ui_component/widget/additional_component/short_address.dart';
import 'package:test_ta_1/ui_component/widget/alert_component/dialog_alert.dart'; // Import alertdialog.dart
...
class _ScheduleState extends State<Schedule> {
  ...
  Container header(BuildContext context, PropertyModel.Datum property) {
    return Container(
      ...
      child: SubPropertyCard(property: property)
    );
